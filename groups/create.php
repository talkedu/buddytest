        ...
        <div id="container">
            ...
            <div id="right-column-wide">
			  ...
			  <div class='box basics'>
					...
					<div id="profile-name">
						<h1 class="fn"><?php _e( 'Create a Group', 'buddypress' ) ?> <?php bp_group_creation_stage_title() ?></h1>
						<!--for breadcrumb-->
					</div>
					<div class="content">
								...
								<?php do_action( 'bp_before_group_creation_content' ) ?>
										...
										<form action="<?php bp_group_creation_form_action() ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
											...
											<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
												...
												<div class="row">
													<div class='label'>
													<label><?php _e('Enable comment wire', 'buddypress') ?></label>
													</div>
													<div class='input'>
												...
												<?php if ( function_exists('bp_forums_setup') ) : ?>
													<?php if ( bp_forums_is_installed_correctly() ) : ?>
														<div class="row alt">
														<div class='label'>
															<label><?php _e('Enable discussion forum', 'buddypress') ?></label>
														</div>
														<div class='input'>
													...
													<?php else : ?>
														<?php if ( is_site_admin() ) : ?>
															<div class="row">
																	<div class='label'>
																<label> <?php printf( __('<strong>Attention Site Admin:</strong> Group forums require the <a href="%s">correct setup and configuration</a> of a bbPress installation.', 'buddypress' ), $bp->root_domain . '/wp-admin/admin.php?page=buddypress/bp-forums.php' ) ?></label>
																</div>
																<div class='input'>
